                        ...
                        <div class="product-gallery">
                            <div class="quickview-slider-active">
                                <div class="single-slider">
                                    <img src="<?= get_template_directory_uri() ?>/images/modal1.jpg" alt="#">
                                </div>
                                <div class="single-slider">
                                    <img src="<?= get_template_directory_uri() ?>/images/modal2.jpg" alt="#">
                                </div>
                                <div class="single-slider">
                                    <img src="<?= get_template_directory_uri() ?>/images/modal3.jpg" alt="#">
                                </div>
                                <div class="single-slider">
                                    <img src="<?= get_template_directory_uri() ?>/images/modal4.jpg" alt="#">
                                </div>
                            </div>
                        </div>
                        <!-- End Product slider -->
...
<!-- Color JS -->
<script src="<?= get_template_directory_uri() ?>/js/colors.js"></script>
<!-- Slicknav JS -->
...
<!-- Fancybox JS -->
<script src="<?= get_template_directory_uri() ?>/js/facnybox.min.js"></script>
<!-- Waypoints JS -->
...
<!-- Ytplayer JS -->
<script src="<?= get_template_directory_uri() ?>/js/ytplayer.min.js"></script>
<!-- Flex Slider JS -->
